...
// Dark theme for Material-UI components
...
function AgentForm() {
  ...
  return (
    <ThemeProvider theme={darkTheme}>
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 min-h-screen py-8">
      <Box sx={{ maxWidth: 900, mx: 'auto' }}>
      <Paper elevation={3} sx={{ borderRadius: 2, overflow: 'hidden', bgcolor: 'grey.900', color: 'white' }}>
        {/* Header */}
        <Box
          sx={{
