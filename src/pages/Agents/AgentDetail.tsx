  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
     ...
     <div 
      ...
      {/* Dialog */}
      <div className="relative bg-gray-800 rounded-xl shadow-xl w-2xl mx-4 max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex justify-between items-center p-6 pb-4 border-b border-gray-600">
          <h2 className="text-xl font-semibold text-white">Agent 详情</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Pricing */}
          <div>
            <h4 className="text-lg font-semibold text-white mb-3">价格模型</h4>
        ...
        {/* Footer */}
        <div className="flex justify-end gap-3 p-6 pt-4 border-t border-gray-600">
          <button
            onClick={onClose}
            className="px-4 py-1 text-gray-300 border border-gray-600 rounded-lg hover:border-gray-500 hover:bg-gray-700 transition-colors"
          >
            取消
          </button>
